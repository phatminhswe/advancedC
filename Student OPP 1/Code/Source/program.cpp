            ...
            switch (choice) {
                ...
                search_student:
                    ...
                    case 1:
                    {
                        ...
                        cout << "\n-------------------------------------------------------------------------------------------------------" << endl;
                        search_by_name_to_show(database, name_input);
                    ...
                    case 2:
                    {
                        ...
                        cout << "\n-------------------------------------------------------------------------------------------------------" << endl;
                        search_by_id_to_show(database, ID_input);
                ...
                sort_student:
                    ...
                    break;
                    case 2:
                    sort_math_score(database);
                    print_list(database);
                    break;
                    case 3:
                    sort_physic_score(database);
                    print_list(database);
                    break;
                    case 4:
                    sort_mechical_score(database);
                    print_list(database);
                    break;
                    case 5:
                    sort_average_score(database);
                    print_list(database);
                    break;
                    default:
...
void search_by_id_to_show(list <Student> database, short int ID_input) {
    ...
    cout << setw(9) << "ID" << setw(9) << "Name" << setw(12) << "Gender" << setw(10) << "  Math  " << setw(6) << "Physic " << setw(6) << "Chemistry " << setw(15) << "Average_score" << setw(10) << "Rank" << endl;
    int cnt = 0;
    list<Student>::iterator it;
    for (it = database.begin(); it != database.end(); ++it) {
        if (it->getID() == ID_input) {
            cout << setw(9) << it->getID() << setw(9) << it->getName() << setw(12) << it->getGender() << setw(8) << it->getMath() << setw(6) << it->getPhysic() << setw(6) << it->getChemical() << setw(15) << it->getAverScore() << setw(14) << it->getRank() << endl;
            cnt++;
        }
...
void print_list(list <Student> database) {
    ...
    for (auto x : database) {
        cout << "\n-------------------------------------------------------------------------------------------------------" << endl;
        cout << setw(9) << x.getID() << setw(9) << x.getName() << setw(12) << x.getGender() << setw(8) << x.getMath() << setw(6) << x.getPhysic() << setw(6) << x.getChemical() << setw(15) << x.getAverScore() << setw(14) << x.getRank() << endl;
